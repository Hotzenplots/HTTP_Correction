...
def Renew_OCS(Para_List):
    ...
    Dic_Response['ZH_LABEL'] = Dic_Response['ZH_LABEL'].replace('资源点001光缆段','资源点光缆段')
    Dic_Response['ZH_LABEL'] = Dic_Response['ZH_LABEL'].replace('资源点光缆段','资源点光缆段01')
...
if __name__ == '__main__':
    Prepare_List()
    Swimming_Pool(Renew_OCS, List_CSV)