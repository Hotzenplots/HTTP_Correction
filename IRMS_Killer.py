...
P3_Generate_Cable_Segment   = True
P4_Cable_Lay                = True
...
if __name__ == '__main__':
    ...
    if P3_Generate_Cable_Segment:
        print('P3-开始')
        if (not P1_Push_Box) and (not P2_Generate_Support_Segment):
            Swimming_Pool(Query_Box_ID_ResPont_ID_Alias, List_Box_Info)
        Prepare_Support_Sys_and_Cable_Sys()
        Query_Project_Code_ID()
    ...
    if P4_Cable_Lay:
        print('P4-开始')
        if (not P1_Push_Box) and (not P2_Generate_Support_Segment) and (not P3_Generate_Cable_Segment):
            Swimming_Pool(Query_Box_ID_ResPont_ID_Alias, List_Box_Info)
            Prepare_Support_Sys_and_Cable_Sys()
            Query_Project_Code_ID()
        ...
        print('P4-结束')
        # Dic_Test = {'A_Box_Name': '太原阳曲县山西豪德置业有限公司企业宽带GF2006号西楼道GF3006', 'Z_Box_Name': '太原阳曲县山西豪德置业有限公司企业宽带GF2007号西楼道GF3007', 'Width': 24, 'A_Box_Type_ID': 9204, 'A_Box_Type': 'guangfenxianxiang', 'A_ResPoint_Type_ID': 9115, 'A_Longitude': 112.717937063552, 'A_Latitude': 38.160451496305804, 'Z_Box_Type_ID': 9204, 'Z_Box_Type': 'guangfenxianxiang', 'Z_ResPoint_Type_ID': 9115, 'Z_Longitude': 112.718337063552, 'Z_Latitude': 38.160451496305804, 'Length': 35, 'Business_Level': 8, 'Life_Cycle': 8, 'Owner_Type': 1, 'Owner_Name': 0, 'Field_Type': '市城区域', 'City_ID': 445835190, 'County_ID': 445835318, 'DQS_Project_ID': 246552123, 'DQS_ID': 246552126, 'DQS_County_ID': 483582248, 'DQS_Maintainer_ID': 685585124, 'Task_Name_ID': '2870791671', 'A_Box_ID': '730421234', 'A_ResPoint_ID': '730421314', 'Z_Box_ID': '730421235', 'Z_ResPoint_ID': '730421315', 'Support_Sys_ID': '805438309', 'Cable_Sys_ID': '805427890', 'Project_Code_ID': '54487', 'Support_Seg_Name': '太原阳曲县山西豪德置业有限公司企业宽带GF2006号西楼道GF3006资源点-太原阳曲县山西豪德置业有限公司企业宽带GF2007号西楼道GF3007资源点引上段', 'Support_Seg_ID': '805553969', 'Cable_Seg_Name': '太原阳曲县山西豪德置业有限公司企业宽带GF2006号西楼道GF3006资源点-太原阳曲县山西豪德置业有限公司企业宽带GF2007号西楼道GF3007资源点光缆段', 'Cable_Seg_ID': '807387045'}
        # Cable_Lay(Dic_Test)
        # print(sorted(List_CS_Info[10].items(), key = lambda item:item[0]))
        # print(List_CS_Info[69])
        # print(List_Box_Info[20])
        # Dic_Test = {'A_Box_Name': '太原阳曲县山西豪德置业有限公司企业宽带7号西楼道GF0096', 'Z_Box_Name': '太原阳曲县山西豪德置业有限公司企业宽带GF1001号西楼道GF1001', 'Width': 24, 'A_Box_Type_ID': 9204, 'A_Box_Type': 'guangfenxianxiang', 'A_ResPoint_Type_ID': 9115, 'A_Longitude': 112.715537063552, 'A_Latitude': 38.1612514963058, 'Z_Box_Type_ID': 9204, 'Z_Box_Type': 'guangfenxianxiang', 'Z_ResPoint_Type_ID': 9115, 'Z_Longitude': 112.715937063552, 'Z_Latitude': 38.1612514963058, 'Length': 35, 'Business_Level': 8, 'Life_Cycle': 8, 'Owner_Type': 1, 'Owner_Name': 0, 'Field_Type': '市城区域', 'City_ID': 445835190, 'County_ID': 445835318, 'DQS_Project_ID': 246552123, 'DQS_ID': 246552126, 'DQS_County_ID': 483582248, 'DQS_Maintainer_ID': 685585124, 'Task_Name_ID': '2870791671', 'A_Box_ID': '730421212', 'A_ResPoint_ID': '730421292', 'Z_Box_ID': '730421213', 'Z_ResPoint_ID': '730421293', 'Support_Sys_ID': '805438309', 'Cable_Sys_ID': '805427890', 'Project_Code_ID': '54487'}
        # Query_Support_Seg_ID_Cable_Seg_ID(Dic_Test)
